...
<p align="center">
  <img src="./img/image1.webp" alt="Add Vector Tile Layer menu option in QGIS" style="max-width: 80%;">
</p>

Add a **New Generic Connection** from the dialogue box and fill in the following details:

<p align="center">
  <img src="./img/image10.webp" alt="New Generic Connection button in the Vector Tile Layer dialog" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image15.webp" alt="Connection details dialog with Name, URL, and Zoom level fields filled in" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image14.webp" alt="OSM Shortbread connection visible in the dropdown list" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image6.webp" alt="QGIS canvas with OSM Standard basemap loaded in the layer panel" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image7.webp" alt="QGIS canvas showing the Palakkad Municipality boundary with the OSM Shortbread vector tile layer added" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image17.webp" alt="Vector Tile Layer Symbology dialog showing default Polygon, Line, and Point rules" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image4.webp" alt="New symbology rule dialog with Label, Layer, and Filter fields configured for roads" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image8.webp" alt="Line symbol styling dialog with increased width and black colour for roads" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image9.webp" alt="QGIS map canvas showing roads styled with a thick black line over the OSM basemap" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image16.webp" alt="Print Layout window with Add Map item being drawn on the canvas" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image5.webp" alt="Print Layout showing the Palakkad area rendered with the OSM Shortbread vector tile layer" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image11.webp" alt="Atlas settings panel with Generate an Atlas enabled and Palakkad Municipality selected as the coverage layer" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image12.webp" alt="Item Properties panel with the Clipping settings icon highlighted" style="max-width: 60%;">
</p>
...
<p align="center">
  <img src="./img/image18.webp" alt="Clipping Settings dialog with Clip to atlas feature enabled and Shortbread layer selected" style="max-width: 60%;">
</p>
...
<p align="center">
  <img src="./img/image19.webp" alt="Preview Atlas toolbar with the Preview Atlas icon highlighted" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image3.webp" alt="Print Layout with north arrow, title, and other map elements added" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image4.webp" alt="Symbology window screenshot used as a legend workaround for vector tiles" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image2.webp" alt="Adding a picture item to the print layout as a legend replacement" style="max-width: 80%;">
</p>
...
<p align="center">
  <img src="./img/image13.webp" alt="Final road network map of Palakkad Municipality created using OSM Vector Tiles" style="max-width: 80%;">
</p>
